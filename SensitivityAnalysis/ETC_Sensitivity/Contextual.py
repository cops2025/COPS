...
# K0 = -1 # no baseline
# K0 = 10 # warm up episodes for infeasible solution in extended LP with cold start

# remove old file
old_filename = 'output/CONTEXTUAL_opsrl' + str(RUN_NUMBER) + f'_K0{K0}.pkl'
...
for sim in range(NUMBER_SIMULATIONS):
    ...
    while episode < NUMBER_EPISODES:
        ...
        print('s_idx_init = {}, CONSTRAINT1 = {:.2f}, C1b = {:.2f}, CONSTRAINT2 = {:.2f}, C2b = {:.2f}'.format(
              s_idx_init, CONSTRAINT1, C1b, CONSTRAINT2, C2b))
        ...
        else: # when the episode is greater than K0, do not learn anything more! let's commit to it!
            t1 = time.time()
        ...
        if episode != 0 and episode%100== 0:
            ...
            filename = 'output/CONTEXTUAL_opsrl' + str(RUN_NUMBER) + f'_K0{K0}.pkl'
            f = open(filename, 'ab')
            ...
            filename = f'output/CONTEXTUAL_BPBG_regr_K0{K0}.pkl'
...
filename = 'output/CONTEXTUAL_regrets_' + str(RUN_NUMBER) + f'_K0{K0}.pkl'
with open(filename, 'wb') as f:
